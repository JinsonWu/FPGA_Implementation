...
HD_PWD='/home/jinson/vivado/Lab07_staDisplay/Lab07_staDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_staDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab07_staDisplay.tcl

...
HD_PWD='/home/jinson/vivado/Lab05_FullSubtractor/Lab05_FullSubtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab05_FullSubtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab05_FullSubtractor.tcl -notrace

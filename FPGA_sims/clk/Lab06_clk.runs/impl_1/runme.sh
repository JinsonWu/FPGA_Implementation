...
HD_PWD='/home/jinson/vivado/Lab06_clk/Lab06_clk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_clk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab06_clk.tcl -notrace

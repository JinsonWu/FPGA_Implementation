...
HD_PWD='/home/jinson/vivado/Lab06_count/Lab06_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab06_count.tcl

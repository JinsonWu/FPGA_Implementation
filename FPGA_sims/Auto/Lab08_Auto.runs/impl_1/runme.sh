...
HD_PWD='/home/jinson/vivado/Lab08_Auto/Lab08_Auto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab08_Auto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab08_Auto.tcl -notrace

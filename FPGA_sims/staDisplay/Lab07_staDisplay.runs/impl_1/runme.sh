...
HD_PWD='/home/jinson/vivado/Lab07_staDisplay/Lab07_staDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_staDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab07_staDisplay.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab10_Adder/Lab10_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab10_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab10_Adder.tcl -notrace

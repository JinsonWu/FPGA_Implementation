...
HD_PWD='/home/jinson/vivado/Lab07_movDisplay/Lab07_movDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_movDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab07_movDisplay.tcl

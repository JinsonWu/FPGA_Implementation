...
HD_PWD='/home/jinson/vivado/Lab08_Keyboard/Lab08_Keyboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab08_Keyboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab08_Keyboard.tcl

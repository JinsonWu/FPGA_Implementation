...
HD_PWD='/home/jinson/vivado/Mux_2/Mux_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_2.tcl

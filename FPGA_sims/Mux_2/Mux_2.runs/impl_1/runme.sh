...
HD_PWD='/home/jinson/vivado/Mux_2/Mux_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux_2.tcl -notrace

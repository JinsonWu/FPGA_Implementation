...
HD_PWD='/home/jinson/vivado/Lab07_movTimer_2/Lab07_movTimer_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_movTimer_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab07_movTimer_2.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab08_Keyboard/Lab08_Keyboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab08_Keyboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab08_Keyboard.tcl -notrace

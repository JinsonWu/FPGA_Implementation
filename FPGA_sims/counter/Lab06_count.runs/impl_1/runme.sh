...
HD_PWD='/home/jinson/vivado/Lab06_count/Lab06_count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab06_count.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab09_Traffic_Light/Lab09_Traffic_Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_Traffic_Light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab09_Traffic_Light.tcl

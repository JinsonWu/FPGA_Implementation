...
HD_PWD='/home/jinson/Desktop/Lab08_Piano/Lab08_Piano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab08_Piano.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab08_Piano.tcl

...
HD_PWD='/home/jinson/vivado/Lab07_movDisplay/Lab07_movDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_movDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab07_movDisplay.tcl -notrace

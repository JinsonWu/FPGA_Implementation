...
HD_PWD='/home/jinson/vivado/Lab07_movTimer_2/Lab07_movTimer_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_movTimer_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab07_movTimer_2.tcl

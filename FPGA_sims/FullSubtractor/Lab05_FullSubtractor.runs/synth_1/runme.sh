...
HD_PWD='/home/jinson/vivado/Lab05_FullSubtractor/Lab05_FullSubtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab05_FullSubtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab05_FullSubtractor.tcl

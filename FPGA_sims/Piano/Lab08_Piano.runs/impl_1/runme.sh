...
HD_PWD='/home/jinson/Desktop/Lab08_Piano/Lab08_Piano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab08_Piano.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab08_Piano.tcl -notrace

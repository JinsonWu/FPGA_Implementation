...
HD_PWD='/home/jinson/vivado/Lab09_PWM/Lab09_PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_PWM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab09_PWM.tcl

...
HD_PWD='/home/jinson/vivado/Lab07_timer/Lab07_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_timer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab07_timer.tcl

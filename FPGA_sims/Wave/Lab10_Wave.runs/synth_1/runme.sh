...
HD_PWD='/home/jinson/vivado/Lab10_Wave/Lab10_Wave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab10_Wave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab10_Wave.tcl

...
HD_PWD='/home/jinson/vivado/Lab09_RGB/Lab09_RGB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_RGB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab09_RGB.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab06_clk_a/Lab06_clk_a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_clk_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab06_clk_a.tcl

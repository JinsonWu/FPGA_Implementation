...
HD_PWD='/home/jinson/vivado/Lab06_clk/Lab06_clk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab06_clk.tcl

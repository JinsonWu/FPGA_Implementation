...
HD_PWD='/home/jinson/vivado/Lab05_Display/Lab05_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab05_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab05_Display.tcl -notrace

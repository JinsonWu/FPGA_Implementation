...
HD_PWD='/home/jinson/vivado/Lab10_Wave/Lab10_Wave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab10_Wave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab10_Wave.tcl -notrace

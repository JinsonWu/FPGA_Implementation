...
HD_PWD='/home/jinson/vivado/Lab07_timer/Lab07_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab07_timer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab07_timer.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab06_clk_a/Lab06_clk_a.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab06_clk_a.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab06_clk_a.tcl -notrace

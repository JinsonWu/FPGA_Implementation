...
HD_PWD='/home/jinson/vivado/Lab09_PWM/Lab09_PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_PWM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab09_PWM.tcl -notrace

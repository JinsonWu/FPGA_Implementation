...
HD_PWD='/home/jinson/vivado/Lab09_Traffic_Light/Lab09_Traffic_Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_Traffic_Light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab09_Traffic_Light.tcl -notrace

...
HD_PWD='/home/jinson/vivado/Lab10_SEQ/Lab10_SEQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab10_SEQ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab10_SEQ.tcl -notrace

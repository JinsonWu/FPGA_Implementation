...
HD_PWD='/home/jinson/vivado/Lab09_RGB/Lab09_RGB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab09_RGB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab09_RGB.tcl
